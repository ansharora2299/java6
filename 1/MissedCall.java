...
public class MissedCall {
	...
	public static void main(String[] args) {
		...
		ArrayList<Phone> missedCalls = new ArrayList<>();
		...
		while(ch!=2){
			...
			case 1:
				...
				Phone call =  new Phone(name, num, t);
				try{
		...
		for (Iterator<Phone> iterator = missedCalls.iterator(); iterator.hasNext(); ) {
		    Phone ca = iterator.next();
